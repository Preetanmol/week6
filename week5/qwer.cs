...
namespace week05
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            birthday_party anmol = new birthday_party();
            anmol.setupPartyList();
            anmol.reverseprintPartyList();
            Console.WriteLine(anmol.printPartyList());
            Console.WriteLine(anmol.reverseprintPartyList());
